...
📍 Poznań, Poland · Open to remote (Poland / EU) & relocation to Germany

Software engineer with **5+ years of commercial experience** building production web
applications with React and TypeScript. I work across the full delivery cycle — from
**frontend architecture and reusable component systems** to **full-stack services,
testing, and AI-powered product features**.
...
**Docker · Docker Compose · GitHub Actions · Git · GitLab · Nginx · CI/CD · Kubernetes**
...
## 📫 Contact
Open to **Frontend, React/Next.js and Full-Stack (Node/NestJS)** roles — remote across
Poland & the EU, open to relocation to Germany.
